...
<html>
<head>
  <meta http-equiv="refresh" content="5;url=http://localhost/cricstars/liveScores.php" />
	...
	<section>
      ...
      foreach ($result1 as $value) 
      {
         ...
         $overs=0;
      	 ...
      	 echo "<h1><a href='main.php ?match_id=" . $matchid . "'>" . $teamAname . " Vs " . $teamBname . "</a></h1>";
